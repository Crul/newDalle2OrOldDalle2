...
def is_valid_data(data):
    ...
    return OPENAI_REGEX.match(url) and data[2] == data[3]
...
old_data_list = list(filter(lambda data: data['date'] < MAX_OLD_DATE, all_data_list))    
new_data_list = list(filter(lambda data: data['date'] > MIN_NEW_DATE, all_data_list))    
